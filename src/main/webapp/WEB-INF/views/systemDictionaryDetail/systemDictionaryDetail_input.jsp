	...
	<div class="main-content">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					基础数据 <small> <i class="icon-double-angle-right"></i> <s:if
							test="id==null">
添加数据字典明细</s:if> <s:else>
编辑数据字典明细</s:else>
					</small>
				</h1>
			</div>
				...
				<div class="col-xs-12">
					...
					<s:form id="systemDictionaryDetailForm" action="systemDictionaryDetail_save"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<s:textfield name="name" placeholder="数据字典明细名称"
						...
						<div class="clearfix form-actions">
							<div class="col-md-offset-3 col-md-9">
								...
								<a href="systemDictionaryDetail.action">
