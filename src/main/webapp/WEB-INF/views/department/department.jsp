		...
		<div class="main-content">
			...
			<div class="page-content">
				<div class="page-header">
					<h1>
						组织机构 <small> <i class="icon-double-angle-right"></i> 部门
							&amp; 列表
						</small>
					</h1>
					<div class="col-sm-6" style="width: 100%">
					
						<a class="btn btn-info" href="department_input.action">新建 <i
							class="icon-plus "></i></a>
						&emsp;
						名称：
...
<%-- 							listValue="name" headerKey="-1" headerValue="--请选择--" /> --%>
						...
						<button type="button" onclick="downloadDomain('department');" class="btn btn-primary">
												...
												<tr <s:if test="id==#parameters['id'][0]">style="color:red"</s:if> >
													...
													<td>
														<div
															...
															<button type="button"
																onclick="updateDomain('department',${id})"
																class="btn btn-xs btn-info">
																<i class="icon-edit bigger-120"></i>
															</button>

															<button type="button"
																onclick="deleteDomain(this,'department_delete.action?id=${id}')"
