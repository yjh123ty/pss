	...
	<div class="main-content">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					角色管理 <small> <i class="icon-double-angle-right"></i> <s:if
							test="id==null">
添加角色</s:if> <s:else>
编辑角色</s:else>
					</small>
				...
				<div class="col-xs-12">
					...
					<s:form id="roleForm" action="role_save"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<s:textfield name="name" placeholder="角色名称"
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-input-readonly">拥有权限</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-input-readonly">可访问菜单</label>
							<div class="col-sm-9">
								<s:checkboxlist list="#menus" name="mids" listKey="id"
									listValue="name"/>
							</div>
						</div>
						<div class="space-4"></div>
