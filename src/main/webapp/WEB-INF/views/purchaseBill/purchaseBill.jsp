		...
		<div class="main-content">
			...
			<div class="page-content">
				<div class="page-header">
					<h1>
						采购模块<small> <i class="icon-double-angle-right"></i> 采购订单
							&amp; 列表
						</small>
					</h1>
					<div class="col-sm-6" style="width: 100%">

						<a class="btn btn-info" href="purchaseBill_input.action">新建 <i
												...
												<tr
													...
													<td>
														<div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
															<!-- 编辑按钮 -->
															<button type="button"
																onclick="updateDomain('purchaseBill',${id})"
															...
															<!-- 删除按钮 -->
															<button type="button"
																onclick="deleteDomain(this,'purchaseBill_delete.action?id=${id}')"
