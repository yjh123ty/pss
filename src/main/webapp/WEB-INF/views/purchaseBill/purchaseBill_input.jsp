	...
	<div class="main-content">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					采购模块 <small> <i class="icon-double-angle-right"></i> <s:if
							test="id==null">
添加采购订单</s:if> <s:else>
编辑采购订单</s:else>
					</small>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<s:form id="purchaseBillForm" action="purchaseBill_save"
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-4">采购员</label>
							<div class="col-sm-9">
								<s:select list="#allBuyers" name="buyer.id" listValue="username"
									listKey="id" />
							</div>
						</div>
