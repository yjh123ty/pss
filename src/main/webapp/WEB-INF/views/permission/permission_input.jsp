	...
	<div class="main-content">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					权限管理 <small> <i class="icon-double-angle-right"></i> <s:if
							test="id==null">
添加权限</s:if> <s:else>
编辑权限</s:else>
					</small>
				...
				<div class="col-xs-12">
					...
					<s:form id="permissionForm" action="permission_save"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<s:textfield name="name" placeholder="权限名称"
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
								for="form-field-1"> 方法名 </label>
							<div class="col-sm-9">
								<s:textfield name="method" placeholder="方法名"
									cssClass="col-xs-10 col-sm-5" id="name" />
								<font size="5px" color="red">&nbsp; * &emsp; </font>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<s:textfield name="descs" placeholder="备注"
									cssClass="col-xs-10 col-sm-5" id="name" />
							</div>
						</div>
						<div class="space-4"></div>
