			...
			<div class="page-content">
				<div class="page-header">
					...
					<div class="col-sm-6" style="width: 100%">
						...
						<a class="btn btn-info" href="systemDictionaryType_input.action">新建 <i
							class="icon-plus "></i></a>
						&emsp;
						名称：
												...
												<tr <s:if test="id==#parameters['id'][0]">style="color:red"</s:if> >
													...
													<td>
														<div
															...
															<button type="button"
																onclick="updateDomain('systemDictionaryType',${id})"
																class="btn btn-xs btn-info">
																<i class="icon-edit bigger-120"></i>
															</button>

															<button type="button"
																onclick="deleteDomain(this,'systemDictionaryType_delete.action?id=${id}')"
